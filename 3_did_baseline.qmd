...
intensive_means_plot_combined <- grid.arrange(plot1, plot3, plot5, ncol = 3, nrow = 1)
intensive_event_plot_combined <- grid.arrange(plot2, plot4, plot6, ncol = 3, nrow = 1)

# Export the combined figure to a file
ggsave("intensive_means_plot_combined.png", intensive_means_plot_combined, width = 18, height = 12)

ggsave("intensive_event_plot_combined.png", intensive_event_plot_combined, width = 18, height = 12)
...
# Arrange the plots into a 2x3 grid
extensive_means_plot_combined <- grid.arrange(plot7, plot9, plot11, plot13, ncol = 4, nrow = 1)
extensive_event_plot_combined <- grid.arrange(plot8, plot10, plot12, plot14, ncol = 4, nrow = 1)

# Export the combined figure to a file
ggsave("extensive_means_plot_combined.png", extensive_means_plot_combined, width = 18, height = 12)

ggsave("extensive_event_plot_combined.png", extensive_event_plot_combined, width = 18, height = 12)
