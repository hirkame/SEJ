...
Data / Sample
- Sample: the male aged between 18 to 30 at least with 12 years education. Employing the conservative sampling. 
- Treatment: aged between 18 - 25
- Control: aged between 26 - 30 without subsidies 

Empirical Strategy (DID)
- Pooled OLS (Dynamic): Pre-trend issue. Appear to be no dynamic TEs? 
- DR DID & IPW DID (Homogeneous)
- Callaway Sant'Anna (Dynamic, but not staggered in our context): Conditional parallel trend with DR estimator

Discussion 
- What empirical approach is more plausible in our context? 
- Is there any potential extentions in the empirical strategy? 
